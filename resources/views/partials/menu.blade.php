<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('in_stock_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.in-stocks.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/in-stocks") || request()->is("admin/in-stocks/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('out_stock_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.out-stocks.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/out-stocks") || request()->is("admin/out-stocks/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-shipping-fast c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.outStock.title') }}
                </a>
            </li>
        @endcan
